...
# col_2009_cy_spa_p_v1.dta
print(names(table(read_dta("data/col_2009_cy_spa_p_v1.dta")$year)))
# col_2011_cy_spa_p_v1.dta
print(names(table(read_dta("data/col_2011_cy_spa_p_v1.dta")$pais)))
# col_2011_cy_spa_p.dta
print(names(table(read_dta("data/col_2011_cy_spa_p.dta")$year)))
# hti_2014_cy_spa-eng_p_v3-0.dta
print(names(table(read_dta("data/hti_2014_cy_spa-eng_p_v3-0.dta")$pais)))
```
