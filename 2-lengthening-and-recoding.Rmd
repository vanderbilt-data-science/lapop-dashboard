...
=======
write_csv(final_wide, paste0("lapop_wide_", lang,"_v4.csv"), na = "NULL ")
>>>>>>> Stashed changes
```
...
```{r}
distinct(final_wide,a4_o)
```



```{r}
distinct(final_wide,b13_d)
distinct(final_wide,jc13_o)
distinct(final_wide,exc16_o)
distinct(final_wide,exc11_o)
```
