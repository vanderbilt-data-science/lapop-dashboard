...
## Calculated field code for custom parameters
...
Cut and paste the code below into a field for Question Short
...
measures_cat_short %>% 
  glue_data("WHEN '{category_short_es}:{varlab_esp}' THEN '{varlab_esp}'")
...
Cut and paste the code below into a calculated field for 'Question Long'
...
measures_cat_short %>% 
  glue_data("WHEN '{category_short_es}:{varlab_esp}' THEN '{qword_esp}'")
